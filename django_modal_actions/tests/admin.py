...
from django_modal_actions.mixins import ModalActionMixin, modal_action, conditional_field
...
class UserAdmin(ModalActionMixin, BaseUserAdmin):
    modal_actions = ["object_action", "object_action_with_form_class", "conditional_fields_action"]
